...
import com.nailora.service.BookingService_1;
...
public class AdminBookingController {
	...
	private final BookingService_1 bookingService;
	...
	@PostMapping
	public BookingDTO create(@RequestParam Long timeSlotId, @RequestParam String customerName,
			@RequestParam String phone, @RequestParam(required = false) String note,
			@RequestParam BigDecimal servicePrice, @RequestParam BigDecimal addOnPrice,
			@RequestParam BigDecimal depositAmount) {
		Booking booking = bookingService.createBooking(timeSlotId, customerName, phone, note, servicePrice, addOnPrice,
				depositAmount);
	...
	@PutMapping("/{id}")
	public BookingDTO update(@PathVariable Long id, @RequestParam(required = false) String customerName,
